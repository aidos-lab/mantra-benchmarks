...
class SCConvModule(BaseBettiNumbersModule):
    def __init__(
    ...
    def general_step(self, batch, batch_idx, step: str):
        ...
        y = s_complexes.other_features["y"].to(torch.float32)
...
def single_experiment_betti_numbers_scconv():
