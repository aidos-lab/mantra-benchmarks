...
from models.cells.transformer.positional_encodings.HodgeLaplacianEigenvectors import HodgeLaplacianEigenvectorsPE
from models.cells.transformer.positional_encodings.RandomWalks import RandomWalkPE
from models.cells.transformer.positional_encodings.ZeroPositionalEncodings import ZeroPE
...
def get_positional_encodings(
    ...
    match pe_type:
        ...
        case PositionalEncodingsType.BARYCENTRIC_SUBDIVISION_RANDOM_WALKS_GRAPH:
            pe_builder = BarycentricSubdivisionRandomWalkPE()
        case PositionalEncodingsType.BARYCENTRIC_SUBDIVISION_GRAPH_EIGENVECTORS:
