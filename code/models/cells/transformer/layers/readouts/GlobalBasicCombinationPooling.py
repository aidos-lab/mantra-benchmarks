...
from models.cells.transformer.layers.readouts.GlobalAddPooling import GlobalAddPooling
...
class GlobalBasicCombinationPooling(BaseReadout):
    ...
    def forward(
        ...
        for key in x.keys():
            readout_result[key] = (self.weight_max * max_pooling_result[key] + self.weight_add * add_pooling_result[key]
